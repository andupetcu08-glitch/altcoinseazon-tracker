...
def main():
    ...
    # 1. Casete Superioare (BTC.D, USDT.D, ETH/BTC)
    ...
    for cid, d in PORTFOLIO.items():
        ...
        coins_out.append({
            ...
            "m_apr": round(d["apr"] / d["entry"], 1), "m_mai": round(d["mai"] / d["entry"], 1)
        })

    port_eur = total_usd * 0.92
    # Formula Rotation Score (tinde spre 70% cand BTC.D scade)
    ...
    output = {
        ...
        "vix": get_yahoo("^VIX"), "dxy": get_yahoo("DX-Y.NYB"),
        "coins": coins_out
    }
