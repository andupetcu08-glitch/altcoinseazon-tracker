...
def run_logic():
    # 1. Luăm prețurile de pe Binance și datele globale
    ...
    <p style='color: #444; font-size: 10px;'>Ultima actualizare: {time.strftime('%H:%M:%S')}</p></body></html>"""
